...
th main.lua -retrain resnet-50.t7 -resetClassifier -LR 0.01  -train_list $train  -val_list $val 
...
th main.lua -retrain save/"model_step_""${rho}"".t7"  -LR 0.01 -rho $rho -learnStep -dynamic -train_list $train  -val_list $val -freezeParam
